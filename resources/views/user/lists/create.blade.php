...
<div class="max-w-lg mx-auto">
    <h1 class="text-2xl font-bold text-slate-900 dark:text-white mb-6">Create Novel List</h1>
    <form action="{{ route('lists.store') }}" method="POST" class="space-y-4 bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800">
        ...
        <button type="submit" class="w-full py-3 bg-slate-900 dark:bg-white text-white dark:text-slate-900 font-bold rounded-xl text-sm">Save</button>
    </form>
</div>
@endsection
