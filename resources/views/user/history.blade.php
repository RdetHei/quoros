    ...
    <div class="overflow-hidden rounded-[28px] border border-neutral-800 bg-[#0d1218]">
        ...
        @empty
            <div class="px-6 py-16 text-center">
                ...
                <a href="{{ route('welcome') }}" class="inline-flex items-center gap-2 rounded-xl border border-neutral-700 bg-white px-5 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-neutral-200">
                    Explore Novels
                </a>
            </div>
        @endforelse
