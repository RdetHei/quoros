...
<form action="{{ route('login') }}" method="POST" class="space-y-5">
    ...
    <div x-data="{ show: false }">
        <div class="flex justify-between items-center mb-2">
            ...
            <a href="#" class="text-xs font-semibold text-neutral-400/90 hover:text-neutral-300 transition-colors">Forgot password?</a>
        </div>
        <div class="relative">
    ...
    <p class="text-center text-sm text-neutral-400 pt-2">
        ...
        <a href="{{ route('register') }}" class="font-semibold text-neutral-400 hover:text-neutral-300 transition-colors">Register for free</a>
    </p>
</form>
@endsection
