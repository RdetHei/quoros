...
<form action="{{ route('register') }}" method="POST" class="space-y-5">
    ...
    <div>
        <label for="name" class="block text-xs font-semibold text-neutral-300 mb-2">Full name</label>
        ...
        @error('name')
            <p class="mt-2 text-xs text-neutral-400 font-medium">{{ $message }}</p>
        @enderror
    </div>

    <div>
        <label for="email" class="block text-xs font-semibold text-neutral-300 mb-2">Email</label>
    ...
    <div x-data="{ show: false }">
        <label for="password" class="block text-xs font-semibold text-neutral-300 mb-2">Password</label>
        <div class="relative">
            ...
            <button type="button" @click="show = !show" class="absolute right-3 top-1/2 -translate-y-1/2 w-8 h-8 inline-flex items-center justify-center text-neutral-500 hover:text-neutral-300 transition-colors" aria-label="Show password">
    ...
    <div x-data="{ show: false }">
        <label for="password_confirmation" class="block text-xs font-semibold text-neutral-300 mb-2">Confirm password</label>
        <div class="relative">
    ...
    <p class="text-center text-sm text-neutral-400 pt-2">
        ...
        <a href="{{ route('login') }}" class="font-semibold text-neutral-400 hover:text-neutral-300 transition-colors">Login</a>
    </p>
</form>
@endsection
