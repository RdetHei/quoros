...
@section('eyebrow', 'Gabung komunitas')
@section('heading', 'Buat akun Quoros')
@section('subheading', 'Gratis untuk pembaca — simpan bookmark, riwayat baca, dan list novel favoritmu.')
...
<form action="{{ route('register') }}" method="POST" class="space-y-5">
    ...
    <div>
        <label for="name" class="block text-xs font-semibold text-slate-300 mb-2">Nama lengkap</label>
    ...
    <div x-data="{ show: false }">
        <label for="password_confirmation" class="block text-xs font-semibold text-slate-300 mb-2">Konfirmasi password</label>
        <div class="relative">
