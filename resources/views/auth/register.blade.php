...
<form action="{{ route('register') }}" method="POST" class="space-y-5">
    ...
    <div x-data="{ show: false }">
        ...
        <div class="relative">
            ...
            <button type="button" @click="show = !show" class="absolute right-3 top-1/2 -tranneutral-y-1/2 p-1.5 text-neutral-500 hover:text-neutral-300 transition-colors" aria-label="Show password">
