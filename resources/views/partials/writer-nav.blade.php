...
<aside class="lg:col-span-3 space-y-6 lg:sticky lg:top-24 self-start">
    <div class="bg-neutral-900 rounded-xl border border-neutral-800 overflow-hidden">
        <div class="px-5 py-4 border-b border-neutral-800">
            <p class="text-[10px] font-medium text-neutral-500 uppercase tracking-wider">Writer Area</p>
            <p class="text-sm font-medium text-white mt-0.5">Manage works & statistics</p>
        </div>
        <nav class="p-2 space-y-0.5">
            <a href="{{ route('dashboard', ['tab' => 'analytics']) }}"
               @class([
                   'flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium transition-colors',
                   'bg-white text-black' => $active === 'stats',
                   'text-neutral-400 hover:bg-neutral-800 hover:text-white' => $active !== 'stats',
               ])>
            ...
            <a href="{{ route('dashboard', ['tab' => 'library']) }}"
               @class([
                   'flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium transition-colors',
                   'bg-white text-black' => $active === 'novels',
                   'text-neutral-400 hover:bg-neutral-800 hover:text-white' => $active !== 'novels',
               ])>
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.75">
            ...
            <a href="{{ route('writer.novels.create') }}"
               class="flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium text-neutral-400 hover:bg-neutral-800 hover:text-white transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.75">
        ...
        <div class="px-5 py-4 border-t border-neutral-800">
            <a href="{{ route('dashboard') }}" class="flex items-center gap-2 text-xs font-medium text-neutral-500 hover:text-white transition-colors">
