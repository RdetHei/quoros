...
<aside class="lg:col-span-3 space-y-6 lg:sticky lg:top-24 self-start">
    <div class="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
        <div class="px-5 py-4 border-b border-slate-100 dark:border-slate-800">
            <p class="text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest">Area Penulis</p>
            <p class="text-sm font-semibold text-slate-900 dark:text-white mt-0.5">Kelola karya & statistik</p>
        </div>
