...
<div class="max-w-2xl mx-auto my-12">
    <div class="bg-white dark:bg-slate-900 rounded-3xl p-8 md:p-10 shadow-xl shadow-slate-200/50 dark:shadow-none border border-slate-100 dark:border-slate-800">
        <div class="mb-8">
            <h1 class="text-3xl font-extrabold text-slate-900 dark:text-white tracking-tight mb-2">Edit Genre</h1>
            <p class="text-slate-500 dark:text-slate-400">Ubah informasi untuk genre <span class="font-bold text-indigo-600">{{ $genre->name }}</span>.</p>
        </div>
